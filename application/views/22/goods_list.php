                            ...
                            <div class="am-u-sm-12 am-u-md-9">
                                <div class="am fr">
                                    <div class="am-form-group am-fl">
                                        <?php $category_id = $this->input->get('category_id') ?: null; ?>
                                    ...
                                    <div class="am-form-group am-fl">
                                        <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                            <input type="text" class="am-form-field" name="goods_name"
                                                   placeholder="请输入商品名称"
                                                   value="<?= $this->input->get('goods_name') ?>">
                            ...
                            <?php if (!empty($list)): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <a href="<?= base_url("uploads/thumb/").$item['image'][0] ?>"
                                    ...
                                    <td class="am-text-middle">
                                           ...
                                           am-badge-<?= $item['goods_status'] == 10 ? 'success' : 'warning' ?>"
                                               ...
                                               <?=  $item['goods_status'] == 10 ? 'success' : 'warning' ?>
                                           </span>
                                    </td>
    ...
    $(function () {
        ...
        $('.j-state').click(function () {
            ...
            layer.confirm('确定要' + (parseInt(data.state) === 10 ? '下架' : '上架') + '该商品吗？'
                ...
                , function (index) {
                    var param = {};
                    param['goods_id'] = data.id;
                    param['state'] = parseInt(data.state) === 10?20:10;
                    $.ajax({
							type: "POST",
							url: "<?= site_url('admin/goods/state') ?>",  //同目录下的php文件
        ...
        // 删除元素
        var url = "<?=site_url('admin/goods/delete') ?>";
