...
class Area extends Admin_Controller{
    ...
    public function index(){
        ...
        if(strpos($type,'&page')){
         ...
         $config['total_rows'] = $this->country_model->counts($status, $country_name, $postage_pid, $continent_pid);
        ...
        //print_r($list);
        return $this->render('country_list.php',compact('list', 'continent', 'postage','links'),$role);
    }
