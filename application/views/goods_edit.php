                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-6 ">
                                    ...
                                    <input type="checkbox" <?php if(in_array($key,$row['style_id'])):?>checked<?php endif;?> name="goods[style_id][]" value="<?=$key?>" id="style_<?=$key?>"><label class="am-form-label2" for="style_<?=$key?>"><?=$item['name']?></label>
                                    <?php endforeach;?>
                                </div>
